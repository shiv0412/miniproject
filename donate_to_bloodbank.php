    ...
    <div class="form_main_container">
      <div class="form_heading_container">
        <center><p class="form_head_p">
          <h2>Register In Blood Bank</h2>
        </p></center>
      </div>
    </div>
    <!--------------Registration Form --------------->
    <div class="registration_form_container">
      <form class="row g-3 form_content" action="bank_donar_receipt.php" method="POST" target="_blank">
  <div class="col-md-6">
    <label for="inputEmail4" class="form-label">Full Name*</label>
    <input type="text" class="form-control" id="inputEmail4" name="name" required placeholder="Enter Full Name">
  </div>
  <div class="col-md-6">
