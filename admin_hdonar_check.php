    ...
    <div class="header_container">
      ...
      <div class="form_heading_container">
        <center><p class="form_head_p">
          <h2>Check Home Service Donars</h2>
        </p></center>
      </div>
    </div>
      <div class="search_page_form_con">
       <div class="registration_form_container">
      <form class="row g-3 form_content" action="admin_hdonar_check.php"  method="POST">
...
<th>Address</th>
<th>Pincode</th>
<th>Available Date1</th>
<th>Available Date2</th>
...
if($check_pass == $password){
  ...
  $sele = "SELECT name,mobile,gender,dob,state,city,address,pincode,available_date1,available_date2,register_date from home_donar WHERE  blood_bank LIKE '$bank_name' order by register_date desc";
 ...
 echo "<td align='center'><a href='tel:" . $row['mobile'] . "'>" .$row['mobile']. "</a></td>";
      ...
      echo "<td>";echo $row['available_date1'];echo "</td>";
      echo "<td>";echo $row['available_date2'];echo "</td>";
