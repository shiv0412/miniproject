...
<!------PHP SRCIPT TO Check User_id END HERE------->
    ...
    <div class="main_content_container">
      <h2>
        <span style="color: darkslateblue">Bank Opening Status</span>
      </h2>
      <hr />
    </div>
...
$email=$row2['email'];
$sql = "UPDATE bank_stock SET status = '$status' WHERE bank_user_id = '$email'";
mysql_query($sql);
echo "Updation done successfully....";
mysql_close();
}
else{
    echo "The Password is wrong updation is discarded...Enter correct Password.";
}
?>
    ...
    <div class="navigate_icon_content">
        <a href="update_status_admin.php" target="_self" title="Back"
