    ...
    <div class="header_container">
      ...
      <div class="form_heading_container">
        <center><p class="form_head_p">
          <h2>Search Nearby Blood Bank</h2>
        </p></center>
      </div>
    </div>
      <div class="search_page_form_con">
       <div class="registration_form_container">
      <form class="row g-3 form_content" action="search_bloodbank.php"  method="POST">
...
elseif(empty($city)){
	...
	$sele = "SELECT Bank_Name,Contact_No,Contact_Person,Email,City,Address,Pincode FROM blood_bank WHERE  Country LIKE '$country' and State LIKE '$state' and City LIKE '$city' ";
