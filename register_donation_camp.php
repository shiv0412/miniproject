...
<html>
  ...
  <body>
    ...
    <p style="margin-top:95px;margin-bottom:130px; font-size:20px;color:#676767;text-align:center;">
    Your Donation Camp Organised Successfully....
    <br/><br/>
</p>
</div>
    <!--------Main Content Area Ends Here---------------------->
     <div class="navigate_icon_content">
      <a href="blood_camp_register.html" target="_self" title="Back"
...
$h=$_POST["address"];
$i=$_POST["pincode"];
$sql = "INSERT INTO `digital_blood_bank`.`blood_camp` 
(`Organization_name`, `Contact_No`, `Contact_Person`, `Email`, `Country`, `State`, `City`,`Venue`,`Pincode` ) 
