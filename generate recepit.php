...
<?php
$con=mysqli_connect("localhost","root","","demo_database");
// Check connection
if (mysqli_connect_errno())
{
echo "Failed to connect to MySQL: " . mysqli_connect_error();
}
$result = mysqli_query($con,"SELECT id  FROM homedonar order by id desc limit 1");
...
mysql_select_db("demo_database") or die("unable to find database");
$a=$_POST["name"];
$b=$_POST["mobile"];
$c=$_POST["gender"];
$d=$_POST["dob"];
...
$i=$_POST["address"];
$j=$_POST["pincode"];
$sql = "INSERT INTO `demo_database`.`homedonar` (`name`, `mobile_no`, `gender`, `dob`, `blood`, `state`, `district`, `city`,`address`,`pincode`)
...
$result = mysqli_query($con,"SELECT id ,date,name,mobile_no,gender,blood  FROM homedonar where id='$id'");
...
echo "<td class='receipt_bod'>". $row['id'] . "</td>";
echo "</tr>";
echo "<tr>";
echo "<td class='receipt_left_bod'>". "Registration Date :" . "</td>";
echo "<td class='receipt_bod'>" . $row['date'] . "</td>";
echo "</tr>";
echo "<tr>";
...
echo "</tr>";
echo "<tr>";
echo "<td class='receipt_left_bod'>". "Donar Contacts :" . "</td>";
echo "<td class='receipt_bod'>" . $row['mobile_no'] . "</td>";
echo "</tr>";
echo "<tr>";
echo "<td class='receipt_left_bod'>". "Gender :" . "</td>";
echo "<td class='receipt_bod'>" . $row['gender'] . "</td>";
echo "</tr>";
echo "<tr>";
echo "<td class='receipt_left_bod'>". "Donar Blood Group :" . "</td>";
echo "<td class='receipt_bod'>" . $row['blood'] . "</td>";
echo "</tr>";
}
echo "</table>";
mysqli_close($con);
